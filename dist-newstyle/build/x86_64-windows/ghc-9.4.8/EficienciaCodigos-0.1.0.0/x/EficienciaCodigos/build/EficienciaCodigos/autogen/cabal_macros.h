...
/* package EficienciaCodigos-0.1.0.0 */
#ifndef VERSION_EficienciaCodigos
#define VERSION_EficienciaCodigos "0.1.0.0"
#endif /* VERSION_EficienciaCodigos */
#ifndef MIN_VERSION_EficienciaCodigos
#define MIN_VERSION_EficienciaCodigos(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_EficienciaCodigos */
...
#define CURRENT_COMPONENT_ID "EficienciaCodigos-0.1.0.0-inplace-EficienciaCodigos"
